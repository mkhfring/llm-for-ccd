...
java_results = read_lines(os.path.join(current_location, 'results_for_java3.txt'))
# java_ruby_results = read_lines(os.path.join(current_location, 'results_for_java_ruby2.txt'))
...
original_java_data = read_data(os.path.join(current_location, 'java_test_clone_2.jsonl'))
...
# original_ruby_java_data = read_data(os.path.join(current_location, 'ruby_java_test_clone2.jsonl'))
